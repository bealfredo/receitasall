...
namespace receitasall.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //{
        //    var defaultUserEmail = "defaultuser@example.com"; // Altere para o email desejado
        //    var defaultUserPassword = "DefaultPassword123!"; // Altere para a senha desejada

        //    var user = await UserManager.FindByEmailAsync(defaultUserEmail);
        //    if (user == null)
        //    {
        //        user = new ApplicationUser { UserName = defaultUserEmail, Email = defaultUserEmail };
        //        var result = await UserManager.CreateAsync(user, defaultUserPassword);
        //        if (result.Succeeded)
        //        {
        //            // Se precisar, pode adicionar roles ou realizar outras configurações aqui
        //            return Content("Usuário padrão criado com sucesso.");
        //        }
        //        else
        //        {
        //            return Content("Erro ao criar usuário padrão: " + string.Join(", ", result.Errors));
        //        }
        //    }

        //    return Content("Usuário padrão já existe.");
        //}
